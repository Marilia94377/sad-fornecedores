...
# Botão para avançar para o modelo de decisão
            ...
            for outro_fornecedor in df.index:
                if fornecedor != outro_fornecedor:
                    for criterio in df.columns:
                        ...
                        preferencia = aplicacr_funcao_preferencia(funcoes_preferencia[fornecedor][criterio], diferenca, parametros_preferencia[fornecedor].get(criterio, {}))
